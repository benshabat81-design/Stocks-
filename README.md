...
### ניתוח חדשות חכם ב-AI (אופציונלי)
בלשונית **סורק שוק → חדשות אחרונות** אפשר להפעיל ניתוח חכם בעברית לכל כתבה
(טיקרים קשורים, סנטימנט, סיכום, המלצה וציון דחיפות 1–5) באמצעות Claude API.
ב-**Settings → Secrets** הוסף:
```toml
ANTHROPIC_API_KEY = "sk-ant-..."
# אופציונלי - מודל זול יותר לחיסכון בעלות:
# ANTHROPIC_MODEL = "claude-haiku-4-5"
```
המפתח נוצר ב-[console.anthropic.com](https://console.anthropic.com). העלות לכתבה היא אגורות בודדות.
